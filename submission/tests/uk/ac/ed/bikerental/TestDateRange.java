...
class TestDateRange {
    ...
    void testOverlapsTrue() {
    	...
    	boolean o1 = dateRange1.getEnd().isAfter(dateRange2.getStart())
    			&& (dateRange1.getEnd().isBefore(dateRange2.getEnd()));
    	assertEquals(o1,dateRange1.overlaps(dateRange2));
        //fail();
    }
    ...
    void testOverlapsFalse() {
    	...
    	boolean o2 = dateRange2.getEnd().isBefore(dateRange3.getStart())
    			&& (dateRange2.getEnd().isBefore(dateRange3.getEnd()));
    	assertEquals(o2,dateRange2.overlaps(dateRange3));
        //fail();
    }
